            ...
            },
            {
                ...
                "attributes": [
                    ...
                    _attr(
                        "jaw",
                        "Jaw",
                        ["Soft", "Defined", "Strong", "Square", "Narrow"],
                        "{} jaw",
                    ),
            ...
            },
            {
                ...
                "attributes": [
                    ...
                    _attr(
                        "beard_color",
                        "Beard Color",
                        ["Same as Hair", "Black", "Brown", "Blonde", "Gray", "White"],
                        "{} beard",
                        skip=("Same as Hair",),
                    ),
                ],
            },
            {
                ...
                "attributes": [
                    ...
                    _attr(
                        "piercings",
                        "Piercings",
                        ["None", "Ear", "Nose", "Eyebrow", "Multiple"],
                        "{} piercings",
                    ),
                    _attr(
                        "glasses",
        ...
        "categories": [
            ...
            },
            {
                ...
                "attributes": [
                    ...
                    _attr(
                        "jaw", "Jaw", ["Soft", "Defined", "Strong", "Narrow"], "{} jaw"
                    ),
                    _attr("nose", "Nose", _NOSES, "{} nose"),
                    _attr("eye_shape", "Eye Shape", _EYE_SHAPES, "{} eye shape"),
                    _attr("eye_color", "Eye Color", _EYE_COLORS, "{} eyes"),
            ...
            },
            {
                ...
                "attributes": [
                    ...
                    _attr("hair_texture", "Hair Texture", _HAIR_TEXTURES, "{} hair"),
                    _attr(
                        "hair_style", "Hair Style", _HAIR_STYLES_WOMAN, "{} hairstyle"
                    ),
                ],
            },
            {
                ...
                "attributes": [
                    ...
                    _attr(
                        "piercings",
                        "Piercings",
                        ["None", "Ear", "Nose", "Eyebrow", "Lip", "Multiple"],
                        "{} piercings",
                    ),
                    _attr(
                        "glasses",
            ...
            },
            {
                ...
                "attributes": [
                    _attr(
                        "size",
                        "Size",
                        ["Tiny", "Small", "Medium", "Large", "Very Large", "Giant"],
                        "{} size",
                    ),
                    _attr(
                        "body_type",
                    ...
                    _attr(
                        "pattern",
                        "Pattern",
                        ["Solid", "Spotted", "Striped", "Patches", "Gradient", "Mixed"],
                        "{} pattern",
                        skip=("Solid",),
                    ),
                ],
            },
            {
                ...
                "attributes": [
                    ...
                    _attr(
                        "ear_type",
                        "Ear Type",
                        ["Small", "Large", "Pointed", "Rounded", "Floppy", "Long"],
                        "{} ears",
                    ),
                    _attr(
                        "tail",
                        "Tail",
                        ["None", "Short", "Long", "Bushy", "Curled", "Thin"],
                        "{} tail",
                    ),
                ],
            },
