...
def build_appearance_prompt(
    char_type: str, attributes: Dict[str, str], custom_description: str = ""
) -> str:
...
def should_use_scene_style_override(
    scene_characters: list, project: str = "test_project"
) -> bool:
