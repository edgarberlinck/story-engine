...
class DownloadManager:
    ...
    def download_models(
        self, models: List[Tuple[str, str, str]], max_workers: int = None
    ) -> int:
        """
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            ...
            future_to_model = {
                executor.submit(self._single_download, name, url, destination): name
    ...
    def _single_download(
        self, name: str, url: str, destination: str
    ) -> Tuple[bool, str]:
