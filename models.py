...
DEFAULT_MODEL_CONFIGS = {
    "diffusion": {"dtype": "float16", "device": "cpu"},
    "segmentation": {"dtype": "float32", "device": "cpu"},
    "text_generation": {"dtype": "float16", "device": "cpu"},
    "image_to_video": {"dtype": "bfloat16", "device": "cpu"},
    "text_to_speech": {"dtype": "float16", "device": "cpu"},
    "lip_sync": {"dtype": "float16", "device": "cpu"},
    "music_generation": {"dtype": "float16", "device": "cpu"},
}
