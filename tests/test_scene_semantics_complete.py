...
Both characters must be visible at the same time."""
        ...
        self.assertTrue('stage' in spec.scene.environment.lower()
        ...
        self.assertTrue('a woman playing guitar' in explicit_prompt.lower()
    ...
    def test_user_json_example(self):
        ...
        spec = ScenePromptSpec(
            ...
            characters=[
                CharacterSceneData(
                    name="Nikita",
                    identity=CharacterIdentity(gender='young woman',
                                                hair_color='red',
                ...
                CharacterSceneData(
                    name="Roger",
                    identity=CharacterIdentity(gender='muscular man',
                                                skin_tone='dark',
