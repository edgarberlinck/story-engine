...
class TestAdvancedPrompting(unittest.TestCase):
    ...
    def test_build_per_character_tokens(self):
        ...
        characters = [
            {"name": "Hero1", "prompt": "ultra realistic man, athletic build"},
            {"name": "Hero2", "prompt": "anime style woman, slender build"},
        ]
    ...
    def test_blend_styles(self):
        ...
        blend = AdvancedPromptingEngine.blend_styles(
            "ultra_realistic", "cinematic", ratio=0.3
        )
    ...
    def test_build_blended_prompt(self):
        ...
        attributes = {"gender": "male", "age": "30", "body_type": "athletic"}
    ...
    def test_recommend_model_mixed_styles(self):
        ...
        model = AdvancedPromptingEngine.recommend_model(["ultra_realistic", "anime"])
