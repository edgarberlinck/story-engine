...
class TestTokenBudget(unittest.TestCase):
    ...
    def test_token_budget_limits(self):
        ...
        self.assertLessEqual(
            stats["total_tokens_estimated"], 77 * 1.1
        )  # Allow 10% buffer
    ...
    def test_build_token_aware_prompt(self):
        ...
        characters = [
            {
                "name": "Nikita",
                "prompt": "muscular male, age 30-40, short bald black hair, dark skin",
            },
            {
                "name": "Roger",
                "prompt": "athletic male, age 25-35, brown hair, light skin",
            },
        ]
    ...
    def test_character_description_extraction(self):
        ...
        char_prompt = (
            "ultra realistic man, age 30-40, muscular build, short bald black hair"
        )
        attributes = {
            "age": "Adult",
            "body_type": "Muscular",
        ...
        desc, priority = manager.prioritize_character_description(
            char_prompt, attributes
        )
